  ...
  const translations = {
    it: {
      ...
      modalReservation: {
        ...
        subtext: "Esperienza culinaria di carni pregiate alla brace e wine bar a Milano.",
        ...
        tomorrow: "Domani",
        weekend: "Weekend",
        closedNotice: "Il ristorante è chiuso la domenica. Ti invitiamo a selezionare un'altra data.",
        timeLabel: "Orario",
        occasionLabel: "Occasione / Preferenza (opzionale)",
        occRomantic: "Romantica",
        occBirthday: "Compleanno",
        occGraduation: "Laurea",
        occBusiness: "Lavoro",
        occTasting: "Degustazione",
        nameLabel: "Nome e Cognome",
        namePlaceholder: "Mario Rossi",
        phoneLabel: "Telefono / WhatsApp",
        notesLabel: "Note / Intolleranze / Allergie",
        notesPlaceholder: "Segnala eventuali allergie, intolleranze o richieste di tavolo...",
        submitBtn: "Conferma Prenotazione",
        confirmedLabel: "PRENOTAZIONE RICEVUTA",
        confirmedTitle: "Ti Aspettiamo da Skuisito!",
        confirmedDesc: "Il tuo tavolo è stato registrato. Abbiamo inviato un promemoria ai nostri addetti di sala.",
        summaryGuests: "Ospiti:",
        summaryDate: "Data & Ora:",
        summaryName: "Prenotato a nome:",
        summaryOccasion: "Occasione:",
        whatsappConfirmBtn: "Conferma Rapida su WhatsApp",
        addCalendarBtn: "Aggiungi al Calendario (iCal/Google)",
        closeBtn: "Chiudi"
      },
      stickyBar: {
        call: "Chiama",
    ...
    en: {
      ...
      modalReservation: {
        ...
        subtext: "Experience flame-grilled prime steaks and fine wine pairing in Milan.",
        ...
        tomorrow: "Tomorrow",
        weekend: "Weekend",
        closedNotice: "The restaurant is closed on Sundays. Please pick another date.",
        timeLabel: "Time Slot",
        occasionLabel: "Occasion / Preference (optional)",
        occRomantic: "Romantic",
        occBirthday: "Birthday",
        occGraduation: "Graduation",
        occBusiness: "Business",
        occTasting: "Tasting",
        nameLabel: "Full Name",
        namePlaceholder: "John Doe",
        phoneLabel: "Phone / WhatsApp",
        notesLabel: "Special Notes / Allergies",
        notesPlaceholder: "Let us know about allergies, special occasions, or seating preferences...",
        submitBtn: "Confirm Reservation",
        confirmedLabel: "RESERVATION RECEIVED",
        confirmedTitle: "We Look Forward to Welcoming You!",
        confirmedDesc: "Your table reservation has been received. A dining confirmation has been dispatched.",
        summaryGuests: "Guests:",
        summaryDate: "Date & Time:",
        summaryName: "Reserved for:",
        summaryOccasion: "Occasion:",
        whatsappConfirmBtn: "Instant WhatsApp Confirmation",
        addCalendarBtn: "Add to Calendar (iCal/Google)",
        closeBtn: "Close"
      },
      stickyBar: {
        call: "Call",
    ...
    es: {
      ...
      modalReservation: {
        ...
        subtext: "Experiencia culinaria de carnes selectas a la brasa y vinos de autor en Milán.",
        ...
        closedNotice: "El restaurante permanece cerrado los domingos. Por favor selecciona otra fecha.",
        timeLabel: "Horario",
        occasionLabel: "Ocasión / Preferencia (opcional)",
        occRomantic: "Romántica",
        occBirthday: "Cumpleaños",
        occGraduation: "Graduación",
        occBusiness: "Trabajo",
        occTasting: "Degustación",
        nameLabel: "Nombre y Apellidos",
        namePlaceholder: "Juan Pérez",
        phoneLabel: "Teléfono / WhatsApp",
        notesLabel: "Notas / Intolerancias / Alergias",
        notesPlaceholder: "Indícanos cualquier alergia, intolerancia o preferencia de mesa...",
        submitBtn: "Confirmar Reserva",
        confirmedLabel: "RESERVA RECIBIDA",
        confirmedTitle: "¡Te Esperamos en Skuisito!",
        confirmedDesc: "Tu reserva ha sido registrada correctamente. Hemos avisado a nuestro equipo de sala.",
        summaryGuests: "Comensales:",
        summaryDate: "Fecha y Hora:",
        summaryName: "Reservado a nombre de:",
        summaryOccasion: "Ocasión:",
        whatsappConfirmBtn: "Confirmación Rápida por WhatsApp",
        addCalendarBtn: "Añadir al Calendario (iCal/Google)",
        closeBtn: "Cerrar"
      },
      stickyBar: {
        call: "Llamar",
